...
import numpy as np
import argparse
from preprocess_traces import UTC_TIME_DELTA, TRACES, TRACES_AND_EXPECTED_NUM_COLUMNS

# Max error count before throwing an exception in preprocessing
# We expect certain trace lines to be badly printed due to interleaving
# i.e. given a normal number of columns of 9, we could have
# certain lines with 3 and others with 12 fields.
# Longer traces will have more errors so this number may have to be increased.
MAX_ERR_COUNT = 450
