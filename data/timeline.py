...
def get_plotting_ranges(data_dir):
    ...
    td_30min = np.timedelta64(30, 'm')

    td_100min = np.timedelta64(100, 'm')
    td_90min = np.timedelta64(90, 'm')
    td_80min = np.timedelta64(80, 'm')
    td_60min = np.timedelta64(60, 'm')
    td_2hrs = np.timedelta64(2, 'h')
    td_126min = np.timedelta64(126, 'm')
    td_125min = np.timedelta64(125, 'm')


    td_87min = np.timedelta64(87, 'm')
    td_86min = np.timedelta64(86, 'm')


    td_big_min = np.timedelta64(5220-37, 's')
    # td_small_min = np.timedelta64(5160, 's')
    td_small_min = np.timedelta64(5220-38, 's')
    ...
    interesting_time_ranges = {
        ...
        # "1min_middle": (np.datetime64(last_event.end_date) - td_big_min, np.datetime64(last_event.end_date) - td_small_min),
    }
